...
<br>Студент произвёл базовый (первичный) анализ структуры исходных данных, нашёл основные статистические характеристики признаков, привёл первичные выводы о структуре данных и их особенностях.<br>	2 балла
<br>Студент произвёл базовый анализ исходных данных, однако первичные выводы о данных либо не приведены, либо не соответствуют действительности.<br>	1 балл
<br>Базовый анализ данных не произведён.<br>	0 баллов
